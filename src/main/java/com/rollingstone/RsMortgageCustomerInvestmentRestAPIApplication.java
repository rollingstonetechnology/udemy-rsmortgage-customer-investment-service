...
@EnableFeignClients
public class RsMortgageCustomerInvestmentRestAPIApplication extends SpringBootServletInitializer {

    private static final Class<RsMortgageCustomerInvestmentRestAPIApplication> applicationClass = RsMortgageCustomerInvestmentRestAPIApplication.class;
